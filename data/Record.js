 ...
 * Instances are usually only created by {@link Ext.data.DataReader} implementations when processing unformatted data
 * objects.<br>
 * <p>
 ...
 * data types, and a mapping for an {@link Ext.data.DataReader} to extract the field's value from a data object.
 ...
 * <li><b>mapping</b> : String<p style="margin-left:1em">(Optional) A path specification for use by the {@link Ext.data.DataReader} implementation
